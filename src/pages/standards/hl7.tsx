...
export default function Hl7Page({ content, frontmatter }: Hl7PageProps) {
  return (
    <>
      <Head>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-2 text-amber-800">
                  ...
                  always refer to the official HL7 documentation at{' '}
                  <a 
                    href={frontmatter.officialSpec}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  {' '}and work with certified HL7 implementation specialists to ensure compliance 
...
export const getStaticProps: GetStaticProps = async () => {
  try {
    const { content, metadata } = await getContentByPath('content/standards/hl7/index.md');
    ...
    console.error('Error loading HL7 content:', error);
    return {
      notFound: true,
    };
  }
