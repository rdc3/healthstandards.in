...
export default function FhirPage({ content, frontmatter }: FhirPageProps) {
  return (
    <>
      <Head>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-2 text-amber-800">
                  This content is for educational purposes only. For production healthcare applications, 
                  always refer to the official FHIR specification at{' '}
                  <a 
                    href={frontmatter.officialSpec}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  {' '}and work with certified FHIR implementation specialists to ensure compliance 
...
export const getStaticProps: GetStaticProps = async () => {
  try {
    const { content, metadata } = await getContentByPath('content/standards/fhir/index.md');
    ...
    console.error('Error loading FHIR content:', error);
    return {
      notFound: true,
    };
  }
